...
# Description: URL routing configuration for the HackerMap application - maps URLs
#              to views for houses, users, events, and authentication.
...
urlpatterns = [
    # House URLs - listing, detail, create, edit
    ...
    path('following/', FollowingsView.as_view(), name='followings'),
